...
| 竞品 | 关键弱点 |
|:---|:---|
| **Claude Code** | 无长期运行、无本地推理、闭源收费、无多Agent/多媒体生成 |
| **OpenClaw** | 安全灾难：138 个已知漏洞 + 供应链攻击(CVE-2026-25253)；拒绝 MCP 生态 |
| **Hermes Agent** | 抄袭争议（EvoMap 指控 10步核心循环 1:1 复制）；两个月 90K stars 有营销水分 |
